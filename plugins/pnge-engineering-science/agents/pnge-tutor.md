...
|-------|-----------------|-----------------|
| `pnge-geochem-pw:tnav` | Black oil simulation, decline curves, material balance, PVT, nodal analysis, Archie equation | PNGE 321, PNGE 361 |
| `pnge-well-engineering:pnge-mechanics` | Wellbore stress, thick-walled cylinders, burst/collapse, hook load, torque and drag | PNGE 351, PNGE 341, MAE 243 |
| `pnge-well-engineering:frac-design` | Hydraulic fracture geometry, PKN/KGD models, proppant transport, net pressure | PNGE 341 |
| `pnge-well-engineering:wellbore-stability` | In-situ stress, Mohr-Coulomb failure, mud weight window, breakout analysis | PNGE 351, PNGE 341 |
| `pnge-geochem-pw:mass-energy-balance` | Material balances, energy balances, combustion, flash calculations, reaction extent | ChBE 211, ChBE 321 |
| `pnge-geochem-pw:nist-webbook` | Thermodynamic and transport properties of pure fluids (methane, CO2, water) | ChBE 231, ChBE 311 |
| `pnge-core:usgs-produced-waters` | Real brine chemistry for Marcellus, Utica, and other formations | PNGE 361, senior design |
| `pnge-core:eia-data` | U.S. production data, gas prices, storage, electricity | PNGE 411 (economics) |
| `pnge-state-regulatory:wvges-wells` | WV well data, Marcellus/Utica formation depths and locations | PNGE 321, PNGE 331 |
| `pnge-federal-data:wri-aqueduct` | Water risk context for produced water management | PNGE 341, senior design |
| `pnge-economics:fred-prices` | Commodity prices, interest rates for economic analysis | PNGE 411 |
| `pnge-well-engineering:petrophysics` | Log interpretation, Archie Sw, porosity crossplots, brittleness index | PNGE 331, PNGE 361, PNGE 341 |
| `pnge-well-engineering:artificial-lift` | Rod pump, ESP sizing, gas lift, plunger lift, liquid loading criteria | PNGE 361, PNGE 411 |
| `pnge-well-engineering:flow-assurance` | Hydrate prediction, CO2 corrosion, H2S sour service, wax/scale | PNGE 341, PNGE 361, ChBE 411 |
| `pnge-well-engineering:tubing-design` | Tubing force analysis, Lubinski buckling, seal assembly, velocity strings | PNGE 341, PNGE 351 |
| `pnge-well-engineering:perforation-design` | Perforation skin, phasing, limited entry, underbalanced criteria | PNGE 341 |
| `pnge-well-engineering:surface-facilities` | Separator sizing, TEG dehy, compression HP, backpressure effects | PNGE 361, ChBE 311 |
| `pnge-core:pnge-literature` | Unified literature search — OpenAlex, CrossRef, USGS Publications Warehouse, DOE OSTI | Research, capstone |
| `pnge-well-engineering:rta-production` | Arps decline curves, EUR estimation, flowing material balance, production forecasting | PNGE 321, PNGE 411 |
| `pnge-well-engineering:well-test-analysis` | Ei solution, Horner plot, skin factor, Bourdet derivative, wellbore storage | PNGE 321, PNGE 361 |
| `pnge-well-engineering:matrix-acidizing` | HCl carbonate design, HF sandstone design, Hawkins skin, wormhole Damkohler | PNGE 341, PNGE 361 |
| `pnge-well-engineering:completion-diagnostics` | DFIT/minifrac closure, ISIP, step-rate, cluster efficiency, pressure diagnostics | PNGE 341, PNGE 361 |
| `pnge-well-engineering:nodal-analysis-multiphase` | IPR/VLP matching, tubing/choke sensitivity, multiphase nodal optimization | PNGE 361, PNGE 411 |
| `pnge-well-engineering:production-chemistry` | Emulsions, squeeze design, cleanup, incompatibility, corrosion program surveillance | PNGE 341, PNGE 361, ChBE 411 |
| `pnge-well-engineering:well-integrity-barriers` | SCP triage, MIT interpretation, barrier review, leak-path screening | PNGE 351, PNGE 361 |
| `pnge-well-engineering:petroleum-pvt` | Bubble point, Rs, Bo, Bg, separator shrinkage, condensate dropout screening | PNGE 321, PNGE 361 |
| `pnge-engineering-science:fluid-mechanics` | Reynolds number, Darcy-Weisbach, Colebrook-White, Bernoulli, pump power | ChBE 311, MAE 244 |
| `pnge-engineering-science:reaction-engineering` | CSTR/PFR/batch design, Arrhenius, Damkohler, Levenspiel plot, adiabatic T rise | ChBE 321 |
| `pnge-engineering-science:thermo-eos` | Peng-Robinson/SRK EOS, Z-factor, fugacity, VLE, Rachford-Rice flash | ChBE 231, ChBE 311 |
| `pnge-engineering-science:heat-transfer` | Conduction, convection, overall U, LMTD, NTU, transient heating and cooling | ChBE heat transfer / transport |
| `pnge-engineering-science:mass-transfer-separations` | Diffusion, mass-transfer coefficients, HTU/NTU, absorption, stripping, distillation screening | ChBE separations |
| `pnge-engineering-science:aqueous-chemistry-electrochem` | pH, buffers, alkalinity, hardness, Nernst, Faraday, water chemistry | ChBE / water treatment |
| `pnge-engineering-science:materials-fracture-mechanics` | Fracture toughness, stress intensity, Paris law, fatigue, brittle-vs-ductile failure | MAE materials / integrity |
...
Skills: `pnge-core:eia-data` (production context), `pnge-state-regulatory:wvges-wells` (WV wells),
`pnge-geochem-pw:tnav` Module 2 (basic PVT concepts)
...
Skills: `pnge-geochem-pw:tnav` Modules 1, 2, 3, 4; `pnge-core:usgs-produced-waters`
(formation fluid properties); `pnge-state-regulatory:wvges-wells` (offset well depths/pressures);
`pnge-well-engineering:petroleum-pvt` (black-oil properties and fluid classification)
...
Skills: `pnge-geochem-pw:tnav` Module 5 (Archie equation, kriging);
`pnge-geochem-pw:nist-webbook` (formation water resistivity vs. temperature)
...
Skills: `pnge-well-engineering:frac-design`, `pnge-well-engineering:wellbore-stability` (fracture orientation),
`pnge-core:usgs-produced-waters` (brine chemistry), `pnge-federal-data:wri-aqueduct` (water risk),
`pnge-federal-data:fracfocus` (chemical disclosures), `pnge-well-engineering:completion-diagnostics`
(closure pressure, ISIP, step-rate), `pnge-well-engineering:production-chemistry`
...
Skills: `pnge-well-engineering:pnge-mechanics` (casing design, hook load), `pnge-well-engineering:wellbore-stability`
(mud weight window, formation fracture gradient), `pnge-state-regulatory:wvges-wells` (offset
well depths for casing program design), `pnge-well-engineering:well-integrity-barriers`
...
Skills: `pnge-geochem-pw:tnav` Module 4 (IPR, VFP, nodal analysis);
`pnge-well-engineering:pnge-mechanics` (tubing stress); `pnge-core:eia-data` (gas prices for
production optimization); `pnge-core:usgs-produced-waters` (fluid properties);
`pnge-well-engineering:nodal-analysis-multiphase` (production system optimization);
`pnge-well-engineering:petroleum-pvt` (black-oil inputs); `pnge-well-engineering:well-integrity-barriers`
(SCP and barrier troubleshooting); `pnge-well-engineering:production-chemistry`
...
Skills: `pnge-core:eia-data` (price history), `pnge-economics:fred-prices` (current prices,
discount rates), `pnge-core:usgs-minerals` (commodity context)
...
Skills: `pnge-geochem-pw:mass-energy-balance` (all modules), `pnge-geochem-pw:nist-webbook` (fluid
...
Skills: `pnge-geochem-pw:nist-webbook` (equation of state data), `pnge-geochem-pw:mass-energy-balance`
...
Skills: `pnge-engineering-science:heat-transfer` (all modules); `pnge-engineering-science:fluid-mechanics`
...
Skills: `pnge-engineering-science:mass-transfer-separations` (all modules); `pnge-engineering-science:thermo-eos`
(equilibrium support)
...
Skills: `pnge-engineering-science:aqueous-chemistry-electrochem` (all modules);
`pnge-well-engineering:production-chemistry` (applied oilfield chemistry context)

### MAE 201 — Statics / MAE 243 — Mechanics of Materials
Topics: Free body diagrams, stress-strain, bending, Mohr's circle, thin/thick
walled vessels
Skills: `pnge-well-engineering:pnge-mechanics` (thick-walled cylinder, Mohr's circle);
`pnge-well-engineering:wellbore-stability` (in-situ stress)
...
Skills: `pnge-engineering-science:materials-fracture-mechanics` (KIC, Paris law, fatigue);
`pnge-well-engineering:well-integrity-barriers` (applied failure triage)
...
Skills: `pnge-well-engineering:rta-production` (Arps, EUR, FMB); `pnge-well-engineering:well-test-analysis`
(Horner, skin, derivative); `pnge-geochem-pw:tnav` (decline curves, nodal analysis)
...
Skills: `pnge-well-engineering:matrix-acidizing` (full design workflow);
`pnge-well-engineering:wellbore-stability` (fracture gradient for injection limit)
...
Skills: `pnge-engineering-science:fluid-mechanics` (all pipe flow and pump modules)
...
Skills: `pnge-engineering-science:reaction-engineering` (all reactor design modules);
`pnge-engineering-science:thermo-eos` (thermodynamic equilibrium context)
...
This agent is shipped by `pnge-engineering-science`. It references skills in other plugins — install the companions below for full coverage. If a companion is not installed, the agent will still run and will note which pathway is unavailable.

| Companion plugin | Skills referenced |
|---|---|
| `pnge-core` | eia-data, pnge-literature, usgs-minerals, usgs-produced-waters |
| `pnge-economics` | fred-prices |
| `pnge-federal-data` | fracfocus, wri-aqueduct |
| `pnge-geochem-pw` | mass-energy-balance, nist-webbook, tnav |
| `pnge-state-regulatory` | wvges-wells |
| `pnge-well-engineering` | artificial-lift, completion-diagnostics, flow-assurance, frac-design, matrix-acidizing, nodal-analysis-multiphase, perforation-design, petroleum-pvt, petrophysics, pnge-mechanics, production-chemistry, rta-production, surface-facilities, tubing-design, well-integrity-barriers, well-test-analysis, wellbore-stability |
