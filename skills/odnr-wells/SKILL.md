...
| Data source | WVGES + pnge:wvges-wells | ODNR + pnge:odnr-wells | PADEP + pnge:padep-wells |
...
- For cross-basin comparison with WV and PA, use `pnge:wvges-wells` and
  `pnge:padep-wells` alongside this skill.
