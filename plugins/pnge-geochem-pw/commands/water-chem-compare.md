...
1. **pnge-core:usgs-produced-waters** — brine geochemistry for each target formation/basin
2. **pnge-well-engineering:macrostrat** — stratigraphic context (age, lithology, depositional environment)
3. **pnge-core:pnge-literature** (`--source usgs-pw`) — USGS reports and
