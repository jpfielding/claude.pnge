...
1. **pnge-core:pnge-literature** — unified academic search across OpenAlex
...
2. **pnge-federal-data:netl-edx** — NETL datasets and research products related to the topic
3. **pnge-core:datacite-doi** — research-data DOIs (`10.5066` USGS data releases,
