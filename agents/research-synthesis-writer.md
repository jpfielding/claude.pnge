...
| Skill | What It Provides |
|-------|-----------------|
| `pnge:usgs-produced-waters` | Brine geochemistry data for tables and figures |
| `pnge:usgs-minerals` | Commodity statistics for market context tables |
| `pnge:eia-data` | Production and energy data for context figures |
| `pnge:fred-prices` | Current commodity pricing |
| `pnge:wvges-wells` | WV well data for study area descriptions |
| `pnge:macrostrat` | Stratigraphic data for geological context |
| `pnge:comtrade-minerals` | Trade flow data for supply chain figures |
...
|-------------|-------|------------------|---------------|
| USGS PWGDB v3.0 | pnge:usgs-produced-waters | 247 samples | 2026-04-14 |
| USGS MCS 2025 | pnge:usgs-minerals | Li commodity sheet | 2026-04-14 |
```
