...
|-------|-----------------|
| `pnge-economics:fred-prices` | Real-time Li carbonate, Li hydroxide, Mg prices |
| `pnge-core:usgs-minerals` | Annual production, reserves, price trends, end-use breakdown |
| `pnge-core:eia-data` | Energy prices, electricity costs, natural gas costs by state |
| `pnge-economics:worldbank-energy` | Global energy context, EV adoption driving Li demand |
| `pnge-core:usgs-produced-waters` | Brine concentrations for revenue estimation |
| `pnge-economics:comtrade-minerals` | International Li/Mg trade flows and import reliance |
| `pnge-economics:iea-open` | IEA EV tracker — demand projections for battery minerals |
| `pnge-federal-data:wri-aqueduct` | Water stress context — affects water cost and social license |
| `pnge-federal-data:epa-regulatory` | GHGRP/Subpart W GHG emissions baseline + Envirofacts/ECHO compliance context |
...
Use `pnge-core:usgs-produced-waters` to retrieve brine chemistry for the
...
- Produced water volume (bbl/day) — from `pnge-core:eia-data` or state skills

### Step 2 — Revenue Estimation

Use `pnge-economics:fred-prices` and `pnge-core:usgs-minerals` to get current pricing:
...
Use `pnge-core:eia-data` for regional electricity and natural gas prices.
Use `pnge-federal-data:wri-aqueduct` for water stress context (affects freshwater cost).
...
Use `pnge-federal-data:epa-regulatory` (Subpart W mode) for baseline GHG context at
producing facilities.

### Step 7 — Market Context

Use `pnge-core:usgs-minerals`, `pnge-economics:comtrade-minerals`, `pnge-economics:worldbank-energy`,
and `pnge-economics:iea-open` to contextualize:
...
|---|---|
| `pnge-core` | eia-data, usgs-minerals, usgs-produced-waters |
| `pnge-federal-data` | epa-regulatory, wri-aqueduct |
