...
1. **pnge-core:eia-data** — current natural gas and oil prices, regional production volumes, wellhead prices
2. **pnge-economics:fred-prices** — spot commodity prices (Henry Hub gas, WTI crude, Li carbonate)
3. **pnge-core:usgs-minerals** — Li and Mg commodity pricing and demand outlook
4. **pnge-core:usgs-produced-waters** — produced water Li/Mg concentrations for revenue uplift estimate
