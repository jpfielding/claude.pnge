...
|---|---|---|---|
| Sanctions impact on oil prices | `pnge-economics:fred-prices`, `pnge-core:eia-data` | `pnge-economics:worldbank-energy` | Sanctions timeline, enforcement patterns, market response lag, redirection of trade flows |
| OPEC spare capacity and market stability | `pnge-core:eia-data`, `pnge-economics:fred-prices` | `pnge-economics:worldbank-energy` | Quota compliance history, Saudi swing role, US shale response elasticity |
| Domestic lithium extraction viability | `pnge-core:usgs-minerals`, `pnge-core:usgs-produced-waters` | `pnge-economics:comtrade-minerals`, `pnge-economics:fred-prices` | IRA/DPA incentives, supply security premium, breakeven vs. import cost + geopolitical risk |
| China critical mineral dominance risks | `pnge-economics:comtrade-minerals`, `pnge-core:usgs-minerals` | `pnge-core:pnge-literature` | Supply chain mapping, chokepoint analysis, diversification timelines, FEOC implications |
| Energy transition policy impact on O&G | `pnge-core:eia-data`, `pnge-federal-data:epa-regulatory` | `pnge-economics:fred-prices`, `pnge-economics:worldbank-energy` | 45Q economics, methane fee exposure, CBAM competitiveness, transition timeline |
| LNG geopolitics and European energy security | `pnge-core:eia-data`, `pnge-economics:worldbank-energy` | `pnge-economics:fred-prices` | Russia-Europe gas decoupling, US export capacity, Asian demand competition |
| Lithium/magnesium trade war scenarios | `pnge-economics:comtrade-minerals`, `pnge-core:usgs-minerals` | `pnge-economics:fred-prices` | Export controls precedent (China rare earths, gallium/germanium), retaliatory measures, stockpiling calculus |
| Produced water as strategic resource | `pnge-core:usgs-produced-waters`, `pnge-core:usgs-minerals` | `pnge-core:eia-data`, `pnge-core:pnge-literature` | Water-energy nexus, dual-revenue model (disposal cost offset + mineral revenue), policy support |
| Research landscape and technology readiness | `pnge-core:pnge-literature` | `pnge-federal-data:netl-edx` | DOE funding priorities, TRL progression, gap between lab-scale and commercial DLE |
...
- **Trade flow summaries:** Ranked tables from `pnge-economics:comtrade-minerals` data
...
|---|---|---|---|
| US crude production | 13.2 Mb/d | 2024-Q4 | pnge-core:eia-data |
| WTI spot price | $72.50/bbl | 2025-01 avg | pnge-economics:fred-prices |
| US Li imports from Chile | 4,200 tonnes | 2024 | pnge-economics:comtrade-minerals |
...
> **Certainty: MEDIUM** -- Data from pnge-economics:comtrade-minerals confirms Chinese
...
This agent is shipped by `pnge-economics`. It references skills in other plugins — install the companions below for full coverage. If a companion is not installed, the agent will still run and will note which pathway is unavailable.

| Companion plugin | Skills referenced |
|---|---|
| `pnge-core` | eia-data, pnge-literature, usgs-minerals, usgs-produced-waters |
| `pnge-federal-data` | epa-regulatory, netl-edx |
