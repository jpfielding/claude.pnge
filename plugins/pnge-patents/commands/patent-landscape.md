...
1. **pnge-patents:patentsview** — USPTO patent search by CPC class, keyword, and assignee
2. **pnge-core:pnge-literature** — unified search for academic publications
...
3. **pnge-core:usgs-minerals** — Li commodity context driving patent activity
