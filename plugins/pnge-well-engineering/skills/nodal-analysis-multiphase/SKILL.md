...
`pnge-well-engineering:petroleum-pvt`.
...
- Use `pnge-well-engineering:petroleum-pvt` for black-oil and gas property inputs.
- Use `pnge-well-engineering:artificial-lift` for gas lift, rod pump, ESP, or plunger-lift optimization.
- Use `pnge-well-engineering:surface-facilities` for separator and compression constraints.
- Use `pnge-well-engineering:rta-production` or `pnge-well-engineering:well-test-analysis` when inflow uncertainty dominates.
