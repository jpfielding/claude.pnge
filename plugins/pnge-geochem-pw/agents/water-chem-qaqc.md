...
|-------|-----------------|
| `pnge-core:usgs-produced-waters` | Primary brine geochemistry dataset (USGS PWGDB v3.0) |
| `pnge-federal-data:epa-regulatory` | EPA water quality data for cross-reference (Envirofacts/ECHO) |
| `pnge-federal-data:usgs-waterdata` | USGS surface/groundwater quality stations |
| `pnge-federal-data:netl-edx` | NEWTS produced water data from NETL |
| `pnge-well-engineering:production-chemistry` | Field chemistry context (emulsions, scaling, sampling artifacts) |
| `pnge-well-engineering:macrostrat` | Authoritative formation names and stratigraphic hierarchy |
...
Use `pnge-well-engineering:macrostrat` to verify authoritative formation names and
...
| `pnge-federal-data` | epa-regulatory, netl-edx, usgs-waterdata |
| `pnge-well-engineering` | macrostrat, production-chemistry |
