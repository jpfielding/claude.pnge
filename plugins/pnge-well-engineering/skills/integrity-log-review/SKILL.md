...
Document-review skill for the evidence layer beneath `pnge-well-engineering:well-integrity-barriers`.
...
- Use `pnge-well-engineering:well-integrity-barriers` for the barrier and pressure framework.
- Use `api-well-standards` for casing and cement design context.
- Use `pnge-engineering-science:materials-fracture-mechanics` when crack growth or fatigue is implicated.
