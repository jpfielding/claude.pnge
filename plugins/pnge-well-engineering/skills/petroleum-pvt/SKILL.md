...
`pnge-engineering-science:thermo-eos`.
...
- Use `pnge-well-engineering:nodal-analysis-multiphase` for production system optimization.
- Use `pnge-well-engineering:well-test-analysis` and `pnge-well-engineering:rta-production` when fluid properties drive interpretation.
- Use `pnge-well-engineering:surface-facilities` for separator and compression implications.
- Use `pnge-engineering-science:thermo-eos` for compositional EOS calculations and rigorous phase behavior.
