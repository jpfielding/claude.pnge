...
|-------|-----------------|
| `pnge-core:usgs-produced-waters` | Expected concentration ranges by formation for method selection |
| `pnge-well-engineering:production-chemistry` | Field chemistry context — emulsions, solids, sampling artifacts |
| `pnge-federal-data:epa-regulatory` | EPA method references and regulatory reporting requirements (Envirofacts/ECHO) |
| `pnge-geochem-pw:nist-webbook` | Reference thermodynamic data for calibration standards |
| `pnge-core:pnge-literature` | Literature search for analytical methods — auto-routes to DOE OSTI, USGS, OpenAlex, CrossRef |
...
Determine:
- Target formation and expected brine chemistry (use `pnge-core:usgs-produced-waters`)
...
Use `pnge-well-engineering:production-chemistry` to flag:
...
|---|---|
| `pnge-core` | pnge-literature, usgs-produced-waters |
| `pnge-federal-data` | epa-regulatory |
| `pnge-well-engineering` | production-chemistry |
