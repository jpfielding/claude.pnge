...
1. **pnge:usgs-produced-waters** — brine chemistry (Li, Mg, TDS, interferents) for the target formation
2. **pnge:fred-prices** — current Li carbonate, Li hydroxide, and Mg prices
3. **pnge:usgs-minerals** — Li/Mg production stats, reserves, demand context
4. **pnge:eia-data** — produced water volumes, electricity and gas prices by state
5. **pnge:worldbank-energy** — global energy context and EV adoption trends
